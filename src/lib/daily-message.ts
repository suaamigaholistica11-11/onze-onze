const MENSAGENS = [
  "Confia no tempo das coisas: o que é seu chega na hora certa.",
  ...
  "A magia mora nos detalhes que ninguém vê, mas você sente.",
  ...
  "Leveza não é ausência de problema, é confiança no caminho.",
